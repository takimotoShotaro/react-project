              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      <ImagesListView value={row[fields.photo.name]} id={row.id}/>
                    </TableCell>
                    <TableCell>
                      {fields.name.forView(
                    ...
                    <TableCell>
                      {fields.emailAddress.forView(
                        row[fields.emailAddress.name],
                      )}
                    </TableCell>
                    <TableCell>
                      {fields.address.forView(
                        row[fields.address.name],
                      )}
                    </TableCell>
                    <TableCell>
                      {fields.note.forView(
...
export default connect(select)(StaffListTable);
