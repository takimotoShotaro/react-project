...
import StaffFormModal from 'view/staff/form/StaffFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/staff/staffSelectors';

class StaffAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
