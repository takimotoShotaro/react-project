    ...
    <Container style={{paddingTop: 64}}>
      <Box mt={7} mb={12}>
        <Typography variant="body2" gutterBottom marked="center">
          利用規約<br/>
          この利用規約（以下，「本規約」といいます。）は，このウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の提供者（以下，「当方」といいます。）が利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。<br/>
          <br/>
          第1条（適用）<br/>
          ...
          ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，当方に故意又は重大な過失がある場合を除き，当方は一切の責任を負わないものとします。<br/>
          <br/>
          第4条（禁止事項）<br/>
          ...
          <br/>
          第11条（個人情報の取扱い）<br/>
          当方は，本サービスの利用によって取得する個人情報については，当方「プライバシーポリシー」に従い適切に取り扱うものとします。<br/>
          <br/>
          第12条（通知または連絡）<br/>
